  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center p-8">
      <div className="w-full h-64 bg-[#0582CA] rounded-b-full rounded-tl-full pr-6 flex flex-col justify-center text-gray-100">
        <span className="font-arab text-6xl text-right">السلام والحب</span>
        <span className="font-eng text-4xl text-right">peace and love</span>
      ...
      <div className="w-full flex justify-center items-center pt-10">
        <h1 className="font-jap text-4xl font-bold mr-8 uppercase text-white">
          translate-app
        </h1>
        <button
          href="#"
          className="rounded-md bg-gray-300 px-5 py-3 text-xl font-bold text-[#051923] shadow-xs hover:bg-[#051923] hover:text-gray-300 focus-visible:#0582ca start"
